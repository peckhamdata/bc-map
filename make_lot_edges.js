...
console.log('Lot edges before splitting streets: ' + city_builder.lot_edges.length)

city_builder.add_junctions();
city_builder.intersect_parallels();
city_builder.split_streets();

console.log('Lot edges before splitting sreets: ' + city_builder.lot_edges.length)

const hp = require('harry-plotter');

const filename = 'assets/lot_edges.png'
